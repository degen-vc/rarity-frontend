    ...
    return (
        <HeadlessUIModal isOpen={open} onDismiss={closeFunction}>
            <div className="bg-background-end rounded-lg border-2 border-white">
                <ModalHeader title='delete summoner' onClose={closeFunction} />
                <div className="text-center text-white p-4 pb-8 gap-5">
                    <h2>Are you sure you want to delete this summoner?</h2>
                    <h2>
                        <b>This action is IRREVERSIBLE.</b>
                    </h2>
                    <h2>
                        <b>All items and experience will be lost.</b>
                    </h2>
                </div>
