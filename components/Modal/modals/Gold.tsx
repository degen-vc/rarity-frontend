    ...
    return (
        <HeadlessUIModal isOpen={open} onDismiss={closeFunction}>
            <div className="bg-background-end rounded-lg border-2 border-white">
                <ModalHeader title='claim gold summoners' onClose={closeFunction} />
                <div className="text-center text-white p-4 pb-8 gap-5">
                    {summoners.length > 0 ? (
                        <div>
                            <h2>
                                You have {summoners.length} summoners available to claim gold.{' '}
                            </h2>
                        ...
                        <div>
                            <h2>No summoners available to claim gold </h2>
                        </div>
                    )}
                </div>
            </div>
